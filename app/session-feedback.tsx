...
const COPY = {
  ...
  zh: {
    title: "问题与反馈",
    introduction: "如有疑问、使用反馈，或遇到异常情况或技术问题，可在此简要说明。",
    privacy: "请勿填写个人医疗隐私信息，也不要填写具体药品或补充剂名称。",
    testMode: "测试模式：此内容不会被保存。",
    typeLabel: "内容类型",
    feedback: "反馈",
    question: "问题",
    messageLabel: "内容",
    placeholder: "请填写问题或反馈内容",
    characterCount: (count: number) => `已输入 ${count} / 4000 字`,
    required: "请先填写内容再提交。",
    saveFailed: "提交失败，请重试；也可跳过此步骤。",
    submit: "提交",
    saving: "正在提交…",
    skip: "跳过",
    submitted: "感谢你的反馈，内容已记录。",
    submittedTest: "测试完成；本条内容未保存。",
  },
} as const;
