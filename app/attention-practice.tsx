...
const PRACTICE_COPY: Record<Language, PracticeCopy> = {
  ...
  zh: {
    badge: "练习——不会保存",
    introTitle: "在正式光照前试用操作方式",
    introBeforeEmphasis: "这次简短练习使用暗色中性画面，并且",
    introEmphasis: "不会创建或更新实验记录",
    introAfterEmphasis: "。完成一次引导练习后，再继续填写睡前问卷。",
    introCross: "黑色十字出现时作出一次反应。",
    introPause: "暂停练习，然后继续。",
    introEnd: "使用带确认的结束操作来完成练习。",
    start: "开始练习",
    waitingTitle: "等待黑色十字出现",
    waitingTouch: "十字出现后，点击中性练习区域内的任意位置。",
    waitingKeyboard: "十字出现后，点击练习区域，或按空格键或回车键。",
    waitingStatus: "黑色十字尚未出现。",
    crossVisibleTitle: "现在对黑色十字作出反应",
    crossVisibleTouch: "请立即点击中性练习区域内的任意位置。",
    crossVisibleKeyboard: "请立即点击练习区域，或按空格键或回车键。",
    crossVisibleStatus: "黑色十字已经出现。",
    responseAreaWaitingLabel: "中性练习反应区域。请等待黑色十字出现。",
    responseAreaReadyLabel: "中性练习反应区域。黑色十字已经出现，请立即作出反应。",
    earlyResponse: "现在没有十字。正式光照中，这会被记录为一次多余反应；本次练习反应不会保存。",
    crossHit: "已收到黑色十字反应。",
    pauseTitle: "现在练习暂停",
    pauseTouch: "点击下方控制区的“暂停”。",
    pauseKeyboardBeforeKey: "按 ",
    pauseKeyboardAfterKey: " 键暂停。",
    pausedTitle: "已暂停",
    pausedDescription: "练习已经冻结，不会保存练习计时或任何操作。",
    resumeTouch: "点击下方控制区的“继续”。",
    resumeKeyboardBeforeKey: "再次按 ",
    resumeKeyboardAfterKey: " 键继续。",
    endTitle: "现在练习结束操作",
    endTouch: "请在三秒内连续点击两次“结束”。",
    endKeyboard: "请在序列时限内依次输入 E、N、D。",
    endOnlyPractice: "这只会结束练习，不会结束正式光照。",
    tapEndAgain: "请在三秒内再次点击“结束”以完成练习。",
    endWindowExpired: "确认时间已结束，请重新开始结束操作。",
    endSequenceReset: "输入序列已重置，请从 E 重新开始。",
    sequenceProgress: "END 输入进度",
    completeTitle: "练习完成",
    completeBeforeEmphasis: "你已经试用了全部操作。",
    completeEmphasis: "本次练习的任何内容都没有保存。",
    checklistCross: "黑色十字反应",
    checklistPause: "暂停和继续",
    checklistEnd: "带确认的结束操作",
    tryAgain: "再练一次",
    continue: "继续填写睡前问卷",
    controlsLabel: "练习控制",
    pause: "暂停",
    ...
    endAgain: "再次点击以完成",
    switchToKeyboard: "改用电脑控制方式",
    switchToTouch: "改用触屏设备控制方式",
  },
};
