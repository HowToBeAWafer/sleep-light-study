...
7. Only after those checks pass, publish build `2026-08-09-five-session-commitment-v3` and verify the public GitHub Pages bundle. Do not disclose the complete condition order in participant-facing pages.
